...
$query = mysql_query("SELECT * FROM m_user WHERE username = '$username'");
...
<html lang="en">
  <head>
    ...
    <title>RR List | denypribadi</title>
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="username"><?php echo $hasil['full_name']; ?></span>
                            <b class="caret"></b>
                        </a>
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="rr.php">Receiving Order</a></li>
                      </ul>
                  </li>                  
