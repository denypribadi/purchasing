        ...
        <section id="container" >
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">   
                    <!--JUDUL-->
                    <h2><i class="fa fa-shopping-cart"></i> Purchase Request List</h2>
                    <br>
                    <!--PR ADD START-->
                    <div class="row">
                        <div class="col-md-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    <a href="javascript:;"> <i class="fa fa-plus-square"></i> Create New PR</a>
                                    <span class="tools pull-right">
                                        <a href="javascript:;" class="fa fa-chevron-down"></a>
                                    </span>
                                </header>
                                <div class="panel-body">
                                    <form action="pr-header-add.php" class="form-horizontal" method="get">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">PR Code</label>
                                            <div class="col-md-3 col-xs-11">
                                                <input class="form-control form-control-inline input-medium" size="16" type="text"maxlength="5" name='idpr' id="id-idpr-input"/>
                                                <input type="hidden" value="" name="idpr" id="id-idpr-hidden" disabled="disabled"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Request By</label>
                                            <div class="col-md-3 col-xs-11">
                                                <select name="user" class="form-control form-control-inline input-medium" id="id-user-input">
                                                    <?php
                                                    $queryUserList = mysql_query('SELECT * FROM m_user ORDER BY id_user ASC');
                                                    while ($row = mysql_fetch_array($queryUserList, MYSQL_ASSOC)) {
                                                        echo '<option value="' . $row['id_user'] . '">' . $row['id_user'] . ' -- ' . strtoupper($row['full_name']) . '</option>';
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 col-xs-11">
                                                <select name="department" class="form-control form-control-inline input-medium" id="id-department-input">
                                                    <?php
                                                    $queryDeptList = mysql_query('SELECT * FROM m_department ORDER BY department_name ASC');
                                                    while ($row = mysql_fetch_array($queryDeptList, MYSQL_ASSOC)) {
                                                        echo '<option value="' . $row['id_department'] . '">' . strtoupper($row['department_name']) . '</option>';
                                                    }
                                                    ?>
                                                </select>
                                            </div>
